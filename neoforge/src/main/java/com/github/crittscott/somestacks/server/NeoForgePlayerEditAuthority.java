...
/** Preserves NeoForge interaction-event and trailing-click suppression behavior. */
public final class NeoForgePlayerEditAuthority implements PlayerEditAuthority {
    @Override
